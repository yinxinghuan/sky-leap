...
export async function preloadCharacterLibrary(){
  ...
  preloadPromise = (async () => {
    ...
    if (models.size !== CHARACTER_CATALOG.length) throw new Error(`Expected ${CHARACTER_CATALOG.length} character assets, loaded ${models.size}`);
  })();
